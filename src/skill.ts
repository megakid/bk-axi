import { TOP_HELP } from "./cli.js";
import { DESCRIPTION } from "./constants.js";

export const SKILL_DESCRIPTION =
  "Operate Buildkite through the bk-axi CLI - builds, jobs, logs, blocked steps, pipelines, and auth status. Use for checking CI, monitoring builds to blocked or terminal states, unblocking steps, reading Buildkite logs, triggering builds, rebuilding builds, or discovering pipelines.";
